...
import whatsappImage from '../images/whatsapp.png'; // Correct relative path for import
        ...
        <form className="expert-form">
          ...
          <label className="form-label">
            ...
            <div className="whatsapp-input">
              ...
              <input type="text" placeholder="9876543210" className="form-input no-radius-left" />
            </div>
          </label>
