...
const BookingSummaryBar = () => (
  <div className="booking-summary-bar">
    <div className="summary-segment">
      ...
      <div className="summary-value">Zirakpur, Punjab</div>
    </div>
    ...
    <div className="summary-segment">
      ...
      <div className="summary-value">Kasauli, Himachal..</div>
    </div>
    <div className="summary-segment">
      <div className="summary-label">Departure</div>
      <div className="summary-value">14, April 2025</div>
    </div>
    <div className="summary-segment">
      <div className="summary-label">Return</div>
      <div className="summary-value summary-placeholder">tap to add return date</div>
    </div>
    <div className="summary-segment">
      <div className="summary-label">Pickup Time</div>
      <div className="summary-value">10: 00 AM</div>
    </div>
...
const CabSection = ({ setIsBookingActive, isPaymentActive, setIsPaymentActive }) => {
  ...
  return (
    <div className="page-wrapper">
      {/* Show summary bar only when cab section is open */}
      {!isVerifyOpen && !isPaymentActive && <BookingSummaryBar />}
