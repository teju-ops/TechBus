...
const Header = ({ isBookingActive, transportType }) => {
  ...
  // Hide booking form if on cab page, booking active, or transportType is Cabs
  const hideBookingContainer =
    isCabPage || isVerifyPage || isCabBookingPage || transportType === 'Cabs';
    ...
    >
      ...
      <header className="nav-header">
        <div className="nav-container">
          ...
          {/* Menu bar button styled as in the image */}
          <button
          ...
          {/* Mobile menu bar inside nav-container, only visible when open */}
          {isMobileMenuOpen && (
      ...
      {/* Hide custom-booking-container when CabSection is open */}
